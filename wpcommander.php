...
define( 'WPCOMMANDER_VERSION', '0.1.13' );
...
require_once WPCOMMANDER_PATH . 'includes/class-wpcommander-developer-inspect.php';
require_once WPCOMMANDER_PATH . 'includes/class-wpcommander-developer-execute.php';
require_once WPCOMMANDER_PATH . 'includes/class-wpcommander-mutations.php';
require_once WPCOMMANDER_PATH . 'includes/class-wpcommander-media-transfer.php';
